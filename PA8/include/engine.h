...
struct Physics
{
	...
	void add_object(std::string obj, Graphics *m_graphics, btVector3 offset);

	void add_sphere(std::string obj, Graphics *m_graphics, float m, float r, btVector3 offset);

	void add_box(std::string obj, Graphics *m_graphics, float m, btVector3 size, btVector3 offset);

	void add_cylinder(std::string obj, Graphics *m_graphics, float m, btVector3 idk, btVector3 offset);
